...
import cv2
import numpy as np
from indy_driver.msg import comp_wind_info
...
class CellDetectorNode:
    def __init__(self):
        ...
        # Publisher
        self.pub_cell = rospy.Publisher("comp_wind_info", comp_wind_info, queue_size=1)
    ...
    def action(self, data: Image):
        ...
        if self.enable_viz:
            ...
            cv2.imshow("Image Display1: Orange Cell Detection", vis)
            cv2.waitKey(1)
